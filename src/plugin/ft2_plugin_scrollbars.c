...
const scrollBar_t scrollBarsTemplate[NUM_SCROLLBARS] =
{
	...
	/* Config MIDI input */
	/*x,   y,  w,  h,  type,                 style */
	{ 225, 66, 55, 13, SCROLLBAR_HORIZONTAL, SCROLLBAR_FIXED_THUMB_SIZE },  /* SB_MIDI_CHANNEL */
	{ 225, 82, 55, 13, SCROLLBAR_HORIZONTAL, SCROLLBAR_FIXED_THUMB_SIZE },  /* SB_MIDI_TRANSPOSE */
	{ 225, 98, 55, 13, SCROLLBAR_HORIZONTAL, SCROLLBAR_FIXED_THUMB_SIZE },  /* SB_MIDI_SENS */
