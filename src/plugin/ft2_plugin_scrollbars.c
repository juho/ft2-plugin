...
const scrollBar_t scrollBarsTemplate[NUM_SCROLLBARS] =
{
	...
	{ 272, 103, 105, 13, SCROLLBAR_HORIZONTAL, SCROLLBAR_FIXED_THUMB_SIZE },  /* SB_AMP_SCROLL */
	{ 272, 131, 105, 13, SCROLLBAR_HORIZONTAL, SCROLLBAR_FIXED_THUMB_SIZE },  /* SB_MASTERVOL_SCROLL */
